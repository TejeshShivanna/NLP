In this project I have implemented Hidden Markov Model part-of-speech tagger for Catalan. The training data provided is tokenized and tagged; the test data will be provided tokenized, and the tagger will add the tags.

DATA:
A set of training and development data is available in the "Data" directory.
The directory contains the following files in the format:
